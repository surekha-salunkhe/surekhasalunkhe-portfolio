  ...
  return (
    <div className="border-b border-neutral-800 pb-20">
      ...
      <motion.h1
        ...
        transition={{ duration: 0.5 }}
        className="my-4 text-center text-l">
        I'm currently looking for new opportunities, feel free to Contact me. I'll try my best to get back to you as early as possible!
      </motion.h1>
